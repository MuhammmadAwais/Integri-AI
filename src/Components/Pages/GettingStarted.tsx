...
const GettingStarted: React.FC = () => {
  ...
  const handleGetStarted = () => {
    // Mark intro as seen so it doesn't show again
  ...
  return (
    <div
      ref={containerRef}
      className="h-dvh w-full bg-black relative overflow-hidden flex flex-col"
    >
      ...
      <div className="flex-1 relative w-full h-[60%]">
        ...
        <img
          ref={imageRef}
          src="/public/gettingStarted.png" // Using your VR headset image path
          alt="Future VR"
      ...
      >
        ...
        <button
          ...
          className="w-full max-w-sm py-4 rounded-full bg-[#D32F2F] text-white font-bold text-lg shadow-lg shadow-red-900/40 hover:scale-105 hover:bg-[#B71C1C] transition-all duration-300 active:scale-95 cursor-pointer"
        >
          Get Started
        </button>
      </div>
